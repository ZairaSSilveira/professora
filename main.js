...
colunaFeito.addEventListener('dragover', permitirSoltar);
colunaFazendo.addEventListener('dragover', permitirSoltar);

colunaFeito.addEventListener('drop', soltarTarefa);
colunaFazendo.addEventListener('drop', soltarTarefa);
